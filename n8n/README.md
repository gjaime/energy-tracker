...
3. Selecciona `n8n/cfe-workflow.json`
...
|---|---|
| `$env.CFE_SERVICIO_ID` | `CFE_SERVICIO_ID` |
| `$env.CFE_API_KEY` | `N8N_API_KEY` |

Para obtener el `CFE_SERVICIO_ID` tras el primer deploy:
```bash
